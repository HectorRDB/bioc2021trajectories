...
The skeleton of the trajectory is this tree structure, that tracks changes, consistently with the original publication. The _topologyTest_ utilizes this tree structure when fitting curves to the cells of each conditions, as well as random sets of the data, and compare whether the two distributions are similar.
