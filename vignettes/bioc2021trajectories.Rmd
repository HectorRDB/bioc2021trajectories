...
+ We will first present a single-lineage trajectory dataset with two conditions, and conduct a full workflow analysis on that dataset, from integration to differential expression.

+ We will then analyze a more complex dataset.
